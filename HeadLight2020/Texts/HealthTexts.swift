...
struct HealthTexts {
    ...
    static let didYouKnow = "Did you know that bad lighting from electric lights can be detrimental to your wellbeing? Both visible and non-visible light flickering can have many negative side effects."
    static let eyestrain = "Bad lighting can increase the risk of eyestrain and blurred vision."
